...
>>>>>>> a15ffaa5779cfdc8cbeb8a45cdf82650652fb167
...
=== 단일 주문 조회
.curl-request
include::{snippets}/read-order/curl-request.adoc[]

.http-request
include::{snippets}/read-order/http-request.adoc[]

.path-parameters
include::{snippets}/read-order/path-parameters.adoc[]

.http-response
include::{snippets}/read-order/http-response.adoc[]

.response-fields
include::{snippets}/read-order/response-fields.adoc[]
